...
The assignment operator (\texttt{=}) assigns a value to a variable. In addition to the assignment operator, there are also compound assignment operators. These are shortcuts for modifying the value of a variable by performing operations on it, then storing the result.
...
\begin{example}[Three float arguments]
	\phantom{ }
	\begin{minted}{cpp}
...
\begin{example}[Two integer arguments]
...
\begin{example}[Calling functions]
	\phantom{ }
	\begin{minted}{cpp}
int x = 42, y = 13;
