...
\noindent \textit{Eerste versie, juli 2019} % Printing/edition date
}
...
\chapter{Inleiding}
Programma's voor \textbf{Arduino} en \textbf{Arduboy} worden geschreven in \Cpp\index{C++@\Cpp}.
% commentaar in C++
% // of /* */
